    ...
    <div>
      <section className=" py-10">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold text-[#023E8A]  mb-16">
            What Our Readers Are <span className="text-[#023E8A] ">Saying</span>
          </h2>
          <div className="grid md:grid-cols-3 gap-8 ">
            <div className="bg-white p-6 rounded-2xl hover:scale-105 transition-transform duration-300 shadow-lg">
